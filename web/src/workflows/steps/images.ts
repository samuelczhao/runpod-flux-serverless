...
function identityVisualPrompt(
  ...
  return boundedPrompt([
    "Use the person in the reference image only as the identity and appearance guide for the dreamer. Preserve their recognizable facial structure, skin tone, eyes, nose, mouth, hairstyle, age, distinctive features, and clothing cues. Every mention of a person, figure, traveler, protagonist, or 'I' in the scene description refers to this same single dreamer, whose one body performs the described action. Create one single continuous visual moment from one perspective, with a completely new environmental composition, pose, framing, and background. The dreamer appears exactly once as a full-body or three-quarter figure actively participating in the described event; any other required characters have clearly different faces and clothing. Favor a wide or medium-wide storybook view where the action and setting occupy most of the image and the dreamer occupies about one third of the frame. Apply the selected illustrated medium consistently to the dreamer's face, skin, hair, body, clothing, and the entire world, preserving likeness through recognizable shapes and features with natural facial proportions.",
