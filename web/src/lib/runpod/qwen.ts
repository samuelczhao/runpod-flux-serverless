...
function plannerInstructions(): string {
  return [
    ...
    "A continuous moment with one setting and central action is exactly one scene; never split its subject, action, or lighting into separate scenes.",
    "Add a scene only for a meaningful change in setting, time, central action, or story beat.",
    "Use two scenes for one meaningful transition, three or four for several distinct beats, and five or six only for long dense sequences.",
    "Never invent a transition or duplicate a beat to reach a familiar story length.",
