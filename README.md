...
Status: the worker, tests, container, and deployment runbook are complete. Live GPU
deployment and benchmark evidence remain pending until account credits are available.
...
The required order is typecheck, tests, then lint. The current suite contains 52 unit
